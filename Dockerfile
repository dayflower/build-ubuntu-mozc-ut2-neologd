...
RUN set -x && \
    cd /root && \
    curl -v -L -o mozc.tar.xz 'https://osdn.net/frs/chamber_redir.php?m=jaist&f=%2Fusers%2F26%2F26305%2Fmozc-2.23.2815.102%2Bdfsg%7Eut2-20171008d%2B20200423.tar.xz' && \
    mkdir mozc && \
