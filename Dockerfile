...
RUN set -x && \
    cd /root && \
    curl -v -L -o mozc.tar.xz https://osdn.net/frs/chamber_redir.php?m=iij&f=%2Fusers%2F24%2F24326%2Fmozc-2.23.2815.102%2Bdfsg%7Eut2-20171008d%2B20190718.tar.xz' && \
    mkdir mozc && \
