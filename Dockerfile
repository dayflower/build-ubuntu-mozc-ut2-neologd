...
RUN set -x && \
    cd /root && \
    curl -v -L -o mozc.tar.xz 'https://ja.osdn.net/frs/chamber_redir.php?m=iij&f=%2Fusers%2F21%2F21831%2Fmozc-2.23.2815.102%2Bdfsg%7Eut2-20171008c%2B20180628.tar.xz' && \
    mkdir mozc && \
